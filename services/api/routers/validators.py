...
@router.put('/validate/node', dependencies=[Depends(check_oid_authentication)], response_model=ValidationResult, tags=['nodes'])
...
@router.put('/validate/tag', dependencies=[Depends(check_oid_authentication)], response_model=ValidationResult, tags=['tags'])
...
@router.post('/validate/image', dependencies=[Depends(check_oid_authentication)], response_model=ImageValidationResponse, tags=['ingest'])
