...
for drd in deployments_records_dev:
...
for mmtdr in mm_tags_nodes_records_dev:
...
entries_idmap = {}
for erd in entries_records_dev:
    id_dev = erd['entry_id']
...
files_entry_idmap = {}
for ferd in files_entry_records_dev:
    id_dev = ferd['file_id']
...
for mmetrd in mm_tags_entries_records_dev:
